    ...
    public static void main(String[] args) {
        ...
        while(!end) {
            ...
            for(int i=0; i<ileRound;) {
                ...
                System.out.println("Wybiera: " + gamer1.getGamer());
                char liczba = game.scanerChar();
                Pick result = game.switchGame(liczba);
                System.out.println(result);

                System.out.println("Wybiera: " + gamer2.getGamer());
                Computer computer = new Computer(gamer2);
                int liczba2 = computer.random();
                System.out.println(game.choosen(liczba2).getPickName());
